...
public class SC_Main_DE : MonoBehaviour {
    ...
    public static SC_Main_DE Main_Instance1
    {
        get
        {
            ...
            return SC_Main_DE.Main_Instance;
        }
    }
    ...
    void Update () {
        ...
        switch (game_state)
        {
            ...
            case (Gamestate.GAME_OVER):
                if (End_Screen.activeInHierarchy == false)
                {
                    End_Screen.SetActive(true);
                    PlayerPrefs.SetInt("DepressionCurrentScore", score);
                ...
                // Check_Input();   // -- No longer needed with Alan's shared end screen - J
                break;
    ...
    private void Check_Input()
    {
        switch (game_state)
        {
            ...
            case (Gamestate.PAUSED):
                ...
                break;
            //case (Gamestate.GAME_OVER):            -- Replaced by Alan's shared end screen script - J
            //    if (Input.touchCount > 0)
            //    {
            //        Touch touch = Input.GetTouch(0);
            //        if (touch.phase == TouchPhase.Began)
